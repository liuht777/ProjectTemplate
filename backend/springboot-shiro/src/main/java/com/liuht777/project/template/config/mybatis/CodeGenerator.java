package com.liuht777.project.template.config.mybatis;
...
public class CodeGenerator {
    ...
    public static void main(String[] args) {
        ...
        final String author = scanner("类的作者");
        gc.setAuthor(author);
        gc.setOpen(false);
        ...
        dsc.setUrl("jdbc:mysql://localhost:3306/eistore?autoReconnect=true&useUnicode=true&characterEncoding=UTF-8&useSSL=false");
        ...
        pc.setParent("com.iflytek.cyy.eistore");
